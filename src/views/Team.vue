        ...
        <div class="team-content">
                        ...
                        <div class="member-info">
                            ...
                            <div class="member-links">
                                ...
                                <span
                                    ...
                                    class="member-link-item"
                                    @click.prevent="openLink(member.linkedin!)"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="14"
            ...
            <section class="team-section">
                <h2 class="section-heading">
                    <ITranslate path="team.leadership" />
                </h2>
                <div class="team-grid">
                    <a
            ...
            <section class="team-section">
                <h2 class="section-heading">
                    <ITranslate path="team.alumni" />
                </h2>
                <p class="alumni-note">
                    <ITranslate path="team.alumniNote" />
                </p>
                <div class="team-grid">
                    <a
...
const team: TeamMember[] = [
    {
        name: 'Peter Placzek', 
        role: 'Hub Lead & Developer', 
        github: 'tada5hi', 
        linkedin: 'https://linkedin.com/in/peter-placzek-047a74210/', 
    },
    {
        name: 'Marius Herr', 
        role: 'Coordinator & Analyst', 
        github: 'SirHerr', 
        linkedin: 'https://de.linkedin.com/in/dr-marius-herr-60b89b18b', 
    },
    {
        name: 'Bruce Schultz', 
        role: 'Node Lead & Developer', 
        github: 'brucetony', 
    },
    {
...
const alumni: TeamMember[] = [
    {
        ...
        role: 'Former Node Lead & Developer', 
        github: 'mjugl', 
    },
    {
        name: 'Raphael Rehms', 
