...
const checkCookieConsent = (): boolean => document.cookie.includes('cookie-consent=true');
        ...
        >
            <div class="cookie-content">
                ...
                <div class="cookie-options">
                    <div class="cookie-option">
                        ...
                        <p class="option-description">
                            <ITranslate path="cookie.setting.required.description" />
                        </p>
                    </div>
                    ...
                    <div class="cookie-option">
                        ...
                        <p class="option-description">
                            <ITranslate path="cookie.setting.analysis.description" />
                        </p>
                    </div>
                </div>
                ...
                <div class="cookie-actions">
                    ...
                    >
                        <ITranslate path="cookie.deny" />
                    </button>
                    <button
                        class="btn btn-outline"
                        @click="savePreferences"
                    >
                        <ITranslate path="cookie.preference" />
                    </button>
                    <button
                        class="btn btn-primary"
                        @click="acceptAll"
                    >
                        <ITranslate path="cookie.accept" />
                    </button>
                </div>
            </div>
        </div>
