...
.wave-divider svg {
  ...
  height: 100px;
  display: block;
  /* This attribute is crucial for full width */
  preserveAspectRatio: none;
  /* Remove any potential strokes */
  stroke: none;
  stroke-width: 0;
}

.wave-path {
  fill: var(--body-bg, #ffffff);
  /* Remove any potential strokes */
  stroke: none;
  stroke-width: 0;
  /* Add a slight overlap to prevent any gap */
